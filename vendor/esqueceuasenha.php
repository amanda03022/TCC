...
if (isset($_POST['txtEmail'])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'dcf70ef192c75f';
        $mail->Password = 'ab7ddc0313ded1';
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if (count($msg) == 0 && $qtde > 0) {
                ...
                //Recipients
                $mail->setFrom('uniquetcc5@gmail.com', 'Unique Personalizados');
    ...
    <div class="container">
        <form action="" method="post" name="frmRecuperarSenha">
            ...
            <div class="form-outline mb-4 mt-4">
                ...
                <input type="text" id="txtEmail" name="txtEmail" class="form-control" autofocus required
